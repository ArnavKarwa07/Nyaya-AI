    ...
    <>
        ...
        <section className="landing-hero">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              The Digital Jurist for{" "}
              <span className="highlight-italic">Indian Law.</span>
            </h1>
            <p className="hero-subtitle">
              AI that reasons over Indian legal documents with precision and
              trust. Built specifically for the complexities of the Indian
              judicial system.
            </p>
          ...
          <div className="hero-visual-container">
            <div className="hero-visual-frame">
              <Image
                alt="Legal library interior"
                className="hero-image"
                data-alt="Modern law library with blurred bookshelves and warm lighting"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCnyI_wTou2nRlaGvBucTnKkGgVF6_P22mwfutNw9rNpG6R2XGRKtA_C656LeBgGLGdfbvBGceOstbBZ-a01_rivT-vOiUVi48Nz5Ivn_sR7F9u8F7zcAhmOxucnUBZHiC9mu_oEcNK9FE8DH9qdgPGibRj6-UXyH05wq4EyTms9NNt2i4hv-CI7Ja-WPUnej7M6-Z09lfjy65Wy6IGlY10v2kL5Cu3I4mzg1EOpV1uXKkWmxt-00fZoBHYCIQB6xr7Q4UdR8qNQhA"
                width={1280}
                height={720}
              />
          ...
          <div className="features-container">
            <div className="features-header">
              <h2 className="section-title">
                Precise. Structured. Authoritative.
              </h2>
              <p className="section-subtitle">
                Our suite of tools is designed to handle the nuances of Section
                IPC, Constitution of India, and sprawling case laws.
              </p>
            </div>
            ...
            <div className="bento-grid">
              ...
              <div className="bento-card col-span-7">
                ...
                <p className="bento-desc">
                  Interrogate complex contracts and citations. Our AI
                  doesn&apos;t just summarize; it cross-references every answer
                  with legal precedents from the Supreme Court.
                </p>
                <div className="chat-preview-box">
                  <div className="chat-message-row">
                    <div className="chat-avatar">AI</div>
                    <div className="chat-bubble">
                      &ldquo;Under Section 138 of the NI Act, the notice period
                      is strictly 30 days&rdquo;
                    </div>
                  </div>
                  <div className="chat-reference">
                    Reference: K. Bhaskaran vs. Sankaran Vaidhyan Balan (1999)
                  </div>
                </div>
              </div>
              ...
              <div className="bento-card col-span-5">
                ...
                <p className="bento-desc">
                  Automatically flag contradictory clauses and non-compliance
                  with current Indian legislation.
                </p>
                <div className="alerts-list">
                  <div className="alert-item error-alert">
                    ...
                    <span className="alert-text">
                      Indemnity clause violates IT Act, 2000.
                    </span>
                  </div>
                  <div className="alert-item info-alert">
                    ...
                    <span className="alert-text">
                      Vague arbitration venue definition.
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bento-card col-span-12 flex-row">
                <div className="graph-text-side">
                  ...
                  <p className="bento-desc">
                    Visualize the web of citations. See how one High Court
                    judgment influences others across jurisdictions in a single,
                    interactive map of law.
                  </p>
                  <Link href="/login" className="text-link-btn">
                    Explore the Graph{" "}
                    <span className="material-symbols-outlined icon-small">
                      arrow_outward
                    </span>
        ...
        <section className="trust-section">
          <div className="trust-container">
            ...
            <h2 className="section-title large">
              Built for Legal Experts. <br />
              Powered by Deep Reasoning.
            </h2>
            <p className="trust-quote">
              &ldquo;NyayaLens doesn&rsquo;t just process text; it respects the
              gravity of the legal record. It&rsquo;s the difference between a
              search engine and a digital clerk.&rdquo;
            </p>
      ...
      <footer className="app-footer">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p className="footer-desc">
              Elevating the practice of law through jurisdictional intelligence
          ...
          <div className="footer-links-group">
            ...
            <ul>
              <li>
                <Link href="/chat">Intelligence</Link>
              </li>
              <li>
                <Link href="/amendments">Amendment Tracker</Link>
              </li>
              <li>
                <Link href="/conflicts">Conflict Detection</Link>
              </li>
              <li>
          ...
          <div className="footer-links-group">
            ...
            <ul>
              <li>
                <Link href="/chat">Legal Q&A</Link>
              </li>
              <li>
                <Link href="/conflicts">Conflict Analysis</Link>
              </li>
              <li>
                <Link href="/amendments">Version Comparison</Link>
              </li>
              <li>
                <Link href="/dashboard">Research Timeline</Link>
              </li>
            </ul>
          </div>
          <div className="footer-links-group">
        ...
        <div className="footer-bottom">
          <p>
            © {new Date().getFullYear()} NyayaLens AI. All rights reserved.
            Crafted for the Indian Bar.
          </p>
